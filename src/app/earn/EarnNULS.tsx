  ...
  return (
    <div className="h-[217px] bg-[#262628B2] rounded-lg py-[32px] pl-[32px] pr-[53px] flex flex-col justify-between lg:h-auto lg:p-6">
      <div className="flex-1">
        ...
        <p className="pt-[19px] text-white text-sm lg:py-3">{desc}</p>
      </div>
      <div>
        <Button
          href={link}
...
const items = [
  {
    ...
    desc: 'Stake your NULS on Consensus',
    link: NULSStaking
  },
  {
    title: 'SCO Staking',
    desc: 'Stake your NULS with SCO projects and earn the project tokens instead of NULS',
    link: '/sco'
  },
  {
    title: '3rd Party Staking',
    desc: 'NULS can also be used with 3rd party platforms to earn',
...
function EarnNULS() {
  return (
    <SectionBgWrapper
      ...
      className="pt-[124px] pb-[161px] lg:py-[74px] lg:px-6">
