...
const items = [
  ...
  {
    src: '/ecosystem/PheasantSwap.png',
    name: 'PheasantSwap',
  ...
  {
    src: '/ecosystem/WaterFinance.png',
  ...
  {
    src: '/ecosystem/MyCointainer.png',
    name: 'MyCointainer',
