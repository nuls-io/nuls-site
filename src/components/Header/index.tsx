...
export default function Header() {
  ...
  const { expandMenu, toggleMenu } = useHeaderMobile()
  ...
  return (
    <>
      <header
        className={clsx(
          'w-full fixed top-6 z-[999] duration-700',
        ...
        <div className="wrap flex bg-sub h-[64px] border border-r-0 border-text rounded-lg">
          ...
          <div className="flex-1 flex h-full">
            ...
            <MenuItem href="/ecosystem" label="Ecosystem" borderRight={true} />
            <MenuItem
              href="/developers"
              label="Developers"
              borderRight={true}
            />
            {/* <MenuItem href="/sco" label="Use NULS" borderRight={true} /> */}
      ...
      <header
        className={clsx(
          'hidden lg:block w-full fixed top-0 z-[999] pt-[42px] px-4 transition-header duration-500 overflow-auto pb-10',
          !show && 'opacity-0 translate-y-[-100%]',
          expandMenu ? 'h-full bg-sub' : 'h-[108px]'
        )}>
        <div
          className={clsx(
          ...
          <div className="flex justify-between items-center">
            <Link href="/" className="flex justify-center items-center w-4 h-7">
